...
import { discoverBinding, listTreeEntries, readEvent } from './git.mjs';
import { listPullRequestFiles } from './github.mjs';
import { annotateError, writeGithubOutput, writeStepSummary } from './summary.mjs';
