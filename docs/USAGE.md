...
- `body` видим;
- `title` соответствует контракту;
- присутствует осмысленный семантический или интерактивный UI;
...
- отсутствие мутации входной коллекции;
- синхронность query-функций и наличие возвращаемого значения.
